        ...
        <div className="h-[80vh] w-[90vw] flex items-center justify-center content-center">
          <div className="w-[35vw] h-[40vh] border border-gray-300 rounded-md">
            <div className="flex p-2 items-center border-b border-gray-300">
              <div className="p-2 border border-gray-300 rounded-md">{icon}</div>
            ...
            <div className="p-2">
              ...
              <textarea
                className="border border-gray-300 p-2 w-full mt-2 rounded-md focus:outline-none resize-none font-mono font-light bg-gray-50 h-[5vh]"
                aria-expanded={false}
