      ...
      <div className="flex">
        ...
        <div className="ml-10 mt-3 w-3/4">
          ...
          <div className="mt-3 flex items-center">
            ...
            <textarea
              className="font-mono border-b-2 p-2 resize-none border-green-600 focus:outline-none"
              cols={18}
              rows={1}
          ...
          <div className="ml-4 mt-5">
            ...
            <textarea
              className="font-mono border-2 p-2 w-1/2 mt-2 resize-none border-green-600 rounded-md focus:outline-none"
              cols={20}
              rows={1}
