...
function SelectDs() {
    const sources = [{db: 'MongoDB', icon: <DiMongodb className='text-green-600' size={24}/>}, 
        {db: 'Postgres', icon: <BiLogoPostgresql className='text-blue-600' size={24}/>},
        {db: 'Postgres', icon: <BiLogoPostgresql className='text-blue-600' size={24}/>},
        {db: 'Postgres', icon: <BiLogoPostgresql className='text-blue-600' size={24}/>},
        {db: 'Postgres', icon: <BiLogoPostgresql className='text-blue-600' size={24}/>},
        {db: 'Postgres', icon: <BiLogoPostgresql className='text-blue-600' size={24}/>},
                            ...
                            sources.map((source, idx) => {
                                return (
                                    <>
                                    {
                                        ...
                                        :
                                        <div key={idx} className='flex px-3 mt-2 py-3 rouned-md hover:rounded-md transition-all duration-150 ease-in hover:bg-gray-100 items-center'>
                                            <button className='flex items-center'
                                                onClick={() => setSelectedSource(idx)}
                                            >
                                                <div className='border rounded-md border-gray-300 p-2'>
