...
function Databases() {
    ...
    const dataSources = [{name: 'Sales', tables: ['orders', 'return_sales'], icon: <DiMongodb className='text-green-600' size={24} />},
        {name: 'Social App', tables: ['users', 'posts', 'comments'], icon: <BiLogoPostgresql className='text-blue-600' size={24} />},
        {name: 'Employees', tables: ['lists', 'teams', 'developers'], icon: <SiMysql className='text-yellow-600' size={24} />},
    ];
  ...
  return (
    <>
        <Modal open={showModal} onClose={() => setShowModal(false)}>
            ...
            <div className={`bg-white transition-all duration-700 flex-row ease-in-out rounded-md w-[50vw] max-h-[60vh] h-[60vh] ${showModal ? "scale-100 opacity-100" : "scale-125 opacity-0"}`}>
                <div className='flex p-2 border-b border-gray-300 items-center justify-between'>
                    ...
                    <div className=''>
                        ...
                        className='p-2 border font-light border-gray-300 text-sm rounded-md'>X</button>
                    </div>
                </div>
                <div className='p-2 max-h-[46vh] h-[46vh] overflow-y-scroll'>
                    <div className='flex-row w-full'>
                        ...
                        type="text" placeholder='Untitled table' className='border p-2 bg-gray-50 font-mono font-light border-gray-300 rounded-md focus:outline-none w-full'/>
                    </div>
                    {
                        Array.from({length: table.length + addCol}).map((_, idx) => {
                            return (
                                    ...
                                    <div className='flex items-center transition-all duration-300 ease-in justify-between'>
                                        {
                                            ...
                                            <>
                                                <input
                                                    ...
                                                    type="text" placeholder='Untitled column' className={`border p-2 w-1/2 bg-gray-50 font-mono font-light  ${fillingError && fillingErrorIdx === idx ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none`}/>
                                                <input
                                                    ...
                                                    type="text" placeholder='datatype' className={`border p-2 w-1/2 bg-gray-50 font-mono font-light  ${fillingError && fillingErrorIdx === idx ? "border-red-500" : "border-gray-300"} ml-2 rounded-md focus:outline-none`}/>
                                                <input
                                                    onChange={(e) => {
                                                        setAttr(e.target.value);
                                                    }}
                                                    
                                                    type="text" placeholder='attribute' className={`border p-2 w-1/2 ml-2 bg-gray-50 font-mono font-light  ${fillingError && fillingErrorIdx === idx ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none`}/>
                                            </>
                                        }
                                        <button onClick={() => {
                                           if(colName === "" || dataType === "" || attr === ""){
                                                ...
                                                setTillSavedIdx(idx);
                                                setSaved(true);
                                                setTable([...table, {colName: colName, colDataType: dataType, attribute: attr}]);
                                                setColName("");
                                                setAddCol(0);
                                                setDataType("");
                                                setAttr("");
                                            ...
                                            <TiTick className={`font-light ${tillSavedIdx >= idx ? "text-white" : "text-green-500"}`} size={24}/>
                                        </button>
                                        <button 
                                            onClick={() => {
                    ...
                    <div className='my-3'>
                        <form className="max-w-md mx-auto">   
                            ...
                            <div className="flex border border-gray-300 rounded-lg">
                                ...
                                <input type="search" id="default-search" className="block focus:outline-none w-full p-1 font-mono ps-10 text-sm text-gray-900 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search.." required />
                            </div>
                        </form>
                    </div>
                                ...
                                <div key={idx1} className='my-3 transition-all duration-700 ease-in-out'>
                                    ...
                                    </div>
                                    {
                                        item.tables.map((table, idx) => {
                                            return (
                                                <div>
                                                    <div key={idx} className='mt-1 ml-3 flex hover:bg-gray-100 transition-all duration-200 ease-in-out hover:rounded-md items-center'>
                                                        <button 
                                                            onClick={() => {
                                                        ...
                                                        className='tansition-all duration-200 ease-in-out flex items-center'>
                                                            <MdOutlineChevronRight className={`text-gray-400 ${tableDetailsButton && tableDetailsButtonIdx === idx && SourceIdx === idx1 ? "transition-all duration-300 ease-in-out rotate-90" : ""}`} size={26}/>
                                                    ...
                                                    <div className='ml-10 transition-all duration-700 ease-in-out'>
                                                    {
                                                        ...
                                                        <h1 className={`text-gray-400 ${tableDetailsButton && tableDetailsButtonIdx === idx && SourceIdx === idx1 ? "transition-all duration-300 ease-in-out" : ""}`}>
                                                            Hello
                                                        </h1>
                                                        :
                                                        <>
                ...
                <div className='flex'>
                    <div className='w-3/4 p-4 h-[93vh] border-r flex-row border-gray-300'>
                        <div className=''>
                            ...
                            {
                                showModal === true ?
                                <div className='bg-[#f9fafb] h-[40vh]'>
