      ...
      <div>
        ...
        <div className='flex justify-center items-center'>
            <div className='flex items-center mt-10'>
                <div>
                    <input type="text" className=' w-[60vw] border rounded-md font-light font-mono p-2' placeholder='Search Branches..'/>
                </div>
                <button className='ml-4 border flex items-center p-2 rounded-md'>
            ...
            <div className='w-[77vw]'>
                <div className='border rounded-md'>
                    <div className='px-4 py-2 flex items-center border-b'>
                        <GoIssueOpened className='text-blue-500' size={24}/>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <div className='flex-col'>
                                                <div className='flex items-center'>
                                                    ...
                                                    {branch.tags.map((tag) => {
                                                        return (
                                                            <div className='ml-2 border border-cyan-300 bg-gradient-to-b from-cyan-50 via-cyan-100 to-cyan-50  px-2 rounded-2xl'>
                                                                <h1 className='font-mono  text-cyan-500'>{tag}</h1>
                                                            </div>
                                                        )
                                                    })}
                                                </div>
                                                <div className='ml-3'>
                                                    <h1 className='text-gray-600'>#9 opened by nikhilbhatia08</h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='flex items-center'>
